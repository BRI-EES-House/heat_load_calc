...
class TestRegionLocation(unittest.TestCase):
    ...
    def test_region_season_status(self):
        ...
        # region 1, Kitami
        summer_start, summer_end, winter_start, winter_end, is_summer_period_set, is_winter_period_set = Region(region=ERegion.Region1).get_season_status() 
        ...
        # region 2, Iwamizawa
        summer_start, summer_end, winter_start, winter_end, is_summer_period_set, is_winter_period_set = Region(region=ERegion.Region2).get_season_status() 
        ...
        # region 3, Morioka
        summer_start, summer_end, winter_start, winter_end, is_summer_period_set, is_winter_period_set = Region(region=ERegion.Region3).get_season_status() 
        ...
        # region 4, Nagano
        summer_start, summer_end, winter_start, winter_end, is_summer_period_set, is_winter_period_set = Region(region=ERegion.Region4).get_season_status() 
        ...
        # region 5, Utsunomiya
        summer_start, summer_end, winter_start, winter_end, is_summer_period_set, is_winter_period_set = Region(region=ERegion.Region5).get_season_status() 
        ...
        # region 6, Okayama
        summer_start, summer_end, winter_start, winter_end, is_summer_period_set, is_winter_period_set = Region(region=ERegion.Region6).get_season_status() 
        ...
        # region 7, Miyazaki
        summer_start, summer_end, winter_start, winter_end, is_summer_period_set, is_winter_period_set = Region(region=ERegion.Region7).get_season_status() 
        ...
        # region 8, Naha
        summer_start, summer_end, winter_start, winter_end, is_summer_period_set, is_winter_period_set = Region(region=ERegion.Region8).get_season_status() 
