...
class TestSteadyState(unittest.TestCase):
    ...
    def test_case_01_room_temp(self):
        ...
        self.assertAlmostEqual(0.0 + 100/(6/(1/hc + 1/4.65 - 0.11)),
                               self._dd['rm0_t_r']['1989-12-31 00:00:00'])
    ...
    def test_case_01_surface_temp(self):
        ...
        self.assertAlmostEqual(0.0 + 100/6*(1/4.65 - 0.11), self._dd['rm0_b0_t_s']['1989-12-31 00:00:00'])
