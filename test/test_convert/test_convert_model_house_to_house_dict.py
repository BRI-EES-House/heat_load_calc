...
class ConvertModelHouseToHouseDict(unittest.TestCase):
    ...
    def test_ceiling(self):
        ...
        self.assertEqual(get_ceiling_direction_number(self.gps3, 'top'), 1)
        self.assertEqual(get_ceiling_direction_number(self.gps4, 'top'), 1)
        self.assertEqual(get_ceiling_direction_number(self.gps6, 'top'), 1)
        self.assertEqual(get_ceiling_direction_number(self.gps7, 'top'), 1)
        self.assertEqual(get_ceiling_direction_number(self.gps8, 'top'), 1)
    ...
    def test_wall(self):
        ...
        self.assertEqual(get_wall_direction_number(self.gps1, 'ne'), 2)
        self.assertEqual(get_wall_direction_number(self.gps1, 'se'), 1)
        self.assertEqual(get_wall_direction_number(self.gps1, 'horizontal'), 1)
        self.assertEqual(get_wall_direction_number(self.gps2, 'sw'), 1)
        self.assertEqual(get_wall_direction_number(self.gps2, 'nw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps2, 'ne'), 2)
        self.assertEqual(get_wall_direction_number(self.gps2, 'se'), 1)
        self.assertEqual(get_wall_direction_number(self.gps2, 'horizontal'), 1)
        self.assertEqual(get_wall_direction_number(self.gps3, 'sw'), 1)
        self.assertEqual(get_wall_direction_number(self.gps3, 'nw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps3, 'ne'), 2)
        self.assertEqual(get_wall_direction_number(self.gps3, 'se'), 1)
        self.assertEqual(get_wall_direction_number(self.gps3, 'horizontal'), 1)
        self.assertEqual(get_wall_direction_number(self.gps4, 'sw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps4, 'nw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps4, 'ne'), 2)
        self.assertEqual(get_wall_direction_number(self.gps4, 'se'), 2)
        self.assertEqual(get_wall_direction_number(self.gps5, 'sw'), 1)
        self.assertEqual(get_wall_direction_number(self.gps5, 'nw'), 1)
        self.assertEqual(get_wall_direction_number(self.gps5, 'horizontal'), 1)
        self.assertEqual(get_wall_direction_number(self.gps6, 'sw'), 1)
        self.assertEqual(get_wall_direction_number(self.gps6, 'nw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps6, 'ne'), 2)
        self.assertEqual(get_wall_direction_number(self.gps6, 'se'), 1)
        self.assertEqual(get_wall_direction_number(self.gps6, 'horizontal'), 1)
        self.assertEqual(get_wall_direction_number(self.gps7, 'sw'), 1)
        self.assertEqual(get_wall_direction_number(self.gps7, 'nw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps7, 'ne'), 2)
        self.assertEqual(get_wall_direction_number(self.gps7, 'se'), 1)
        self.assertEqual(get_wall_direction_number(self.gps7, 'horizontal'), 1)
        self.assertEqual(get_wall_direction_number(self.gps8, 'sw'), 1)
        self.assertEqual(get_wall_direction_number(self.gps8, 'nw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps8, 'ne'), 2)
        self.assertEqual(get_wall_direction_number(self.gps8, 'se'), 1)
        self.assertEqual(get_wall_direction_number(self.gps8, 'horizontal'), 1)
        self.assertEqual(get_wall_direction_number(self.gps9, 'sw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps9, 'nw'), 2)
        self.assertEqual(get_wall_direction_number(self.gps9, 'ne'), 2)
        self.assertEqual(get_wall_direction_number(self.gps9, 'se'), 2)
        self.assertEqual(get_wall_direction_number(self.gps10, 'sw'), 1)
        self.assertEqual(get_wall_direction_number(self.gps10, 'nw'), 1)
        ...
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps1, 'nw')[1], 22.365648661814284)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps1, 'ne')[0], 1.1557)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps1, 'ne')[1], 47.92076305426709)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps1, 'se')[0], 22.274523489414282)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps1, 'horizontal')[0], 2.3933)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps2, 'sw')[0], 30.473673540267082)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps2, 'nw')[0], 0.3276)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps2, 'nw')[1], 22.365648661814284)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps2, 'ne')[0], 0.2457)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps2, 'ne')[1], 47.92076305426709)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps2, 'se')[0], 22.274523489414282)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps2, 'horizontal')[0], 0.5733)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps3, 'sw')[0], 30.473673540267082)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps3, 'nw')[0], 0.3276)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps3, 'nw')[1], 22.365648661814284)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps3, 'ne')[0], 0.2457)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps3, 'ne')[1], 47.92076305426709)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps3, 'se')[0], 22.274523489414282)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps3, 'horizontal')[0], 0.5733)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps4, 'sw')[0], 5.304759118263725)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps4, 'sw')[1], 30.46780391407963)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps4, 'nw')[0], 1.8139132205219375)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps4, 'nw')[1], 22.36901951287639)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps4, 'ne')[0], 4.867959118263724)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps4, 'ne')[1], 47.91438134915286)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps4, 'se')[0], 2.3963132205219377)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps4, 'se')[1], 22.277947546942503)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps5, 'sw')[0], 9.43319748790514)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps5, 'nw')[0], 30.053047891194854)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps5, 'horizontal')[0], 12.800973459805142)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps6, 'sw')[0], 30.47024338051379)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps6, 'nw')[0], 1.2376)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps6, 'nw')[1], 22.367618465527734)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps6, 'ne')[0], 1.1557)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps6, 'ne')[1], 47.917033620863265)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps6, 'se')[0], 22.276524388516577)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps6, 'horizontal')[0], 2.3933)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps7, 'sw')[0], 30.47024338051379)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps7, 'nw')[0], 0.3276)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps7, 'nw')[1], 22.367618465527734)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps7, 'ne')[0], 0.2457)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps7, 'ne')[1], 47.917033620863265)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps7, 'se')[0], 22.276524388516577)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps7, 'horizontal')[0], 0.5733)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps8, 'sw')[0], 30.47024338051379)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps8, 'nw')[0], 0.3276)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps8, 'nw')[1], 22.367618465527734)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps8, 'ne')[0], 0.2457)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps8, 'ne')[1], 47.917033620863265)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps8, 'se')[0], 22.276524388516577)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps8, 'horizontal')[0], 0.5733)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps9, 'sw')[0], 5.304991140364853)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps9, 'sw')[1], 30.47024338051379)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps9, 'nw')[0], 1.8138084140079065)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps9, 'nw')[1], 22.367618465527734)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps9, 'ne')[0], 4.868191140364853)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps9, 'ne')[1], 47.917033620863265)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps9, 'se')[0], 2.3962084140079067)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps9, 'se')[1], 22.276524388516577)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps10, 'sw')[0], 9.430740769224983)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps10, 'nw')[0], 30.05729903749555)
        self.assertAlmostEqual(get_wall_area_with_direction(self.gps10, 'horizontal')[0], 12.798613938126838)
    ...
    def test_floor(self):
        ...
        self.assertEqual(get_floor_direction_number(self.gps3, 'downward'), 1)
        self.assertEqual(get_floor_direction_number(self.gps6, 'downward'), 1)
        self.assertEqual(get_floor_direction_number(self.gps7, 'downward'), 1)
        ...
        self.assertAlmostEqual(get_floor_area_with_direction(self.gps3, 'downward')[0], 48.36315762711864)
        self.assertAlmostEqual(get_floor_area_with_direction(self.gps6, 'downward')[0], 45.05075762711864)
        self.assertAlmostEqual(get_floor_area_with_direction(self.gps7, 'downward')[0], 48.36315762711864)
        self.assertAlmostEqual(get_floor_area_with_direction(self.gps8, 'downward')[0], 48.36315762711864)
    ...
    def test_windows(self):
        ...
        self.assertEqual(get_windows_direction_number(self.ws1, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws1, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws1, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ws1, 'se'), 1)
        self.assertEqual(get_windows_direction_number(self.ws2, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws2, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws2, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ws2, 'se'), 1)
        self.assertEqual(get_windows_direction_number(self.ws3, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws3, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws3, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ws3, 'se'), 1)
        self.assertEqual(get_windows_direction_number(self.ws4, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws4, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws4, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ws4, 'se'), 1)
        self.assertEqual(get_windows_direction_number(self.ws5, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws5, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws5, 'horizontal'), 1)
        self.assertEqual(get_windows_direction_number(self.ws6, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws6, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws6, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ws6, 'se'), 1)
        self.assertEqual(get_windows_direction_number(self.ws7, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws7, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws7, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ws7, 'se'), 1)
        self.assertEqual(get_windows_direction_number(self.ws8, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws8, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws8, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ws8, 'se'), 1)
        self.assertEqual(get_windows_direction_number(self.ws9, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws9, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws9, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ws9, 'se'), 1)
        self.assertEqual(get_windows_direction_number(self.ws10, 'sw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws10, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ws10, 'horizontal'), 1)

        def get_windows_area_with_direction(ws: List[WindowNoSpec], key):
            return sorted([s.area for s in ws if s.direction == key])

        self.assertAlmostEqual(get_windows_area_with_direction(self.ws1, 'sw')[0], 22.695293711200005)
        self.assertAlmostEqual(get_windows_area_with_direction(self.ws1, 'nw')[0], 2.3846264596)
        self.assertAlmostEqual(get_windows_area_with_direction(self.ws1, 'ne')[0], 3.628204197200001)
        self.assertAlmostEqual(get_windows_area_with_direction(self.ws1, 'se')[0], 4.365751632000001)
    ...
    def test_doors(self):
        ...
        self.assertEqual(get_windows_direction_number(self.ds1, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ds1, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ds2, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ds2, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ds3, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ds3, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ds4, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ds4, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ds5, 'horizontal'), 1)
        self.assertEqual(get_windows_direction_number(self.ds6, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ds6, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ds7, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ds7, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ds8, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ds8, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ds9, 'nw'), 1)
        self.assertEqual(get_windows_direction_number(self.ds9, 'ne'), 1)
        self.assertEqual(get_windows_direction_number(self.ds10, 'horizontal'), 1)

        def get_doors_area_with_direction(ds: List[DoorNoSpec], key):
            return sorted([s.area for s in ds if s.direction == key])

        self.assertAlmostEqual(get_doors_area_with_direction(self.ds1, 'nw')[0], 1.89)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds1, 'ne')[0], 1.62)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds2, 'nw')[0], 1.89)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds2, 'ne')[0], 1.62)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds3, 'nw')[0], 1.89)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds3, 'ne')[0], 1.62)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds4, 'nw')[0], 1.89)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds4, 'ne')[0], 1.62)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds5, 'horizontal')[0], 1.755)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds6, 'nw')[0], 1.89)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds6, 'ne')[0], 1.62)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds7, 'nw')[0], 1.89)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds7, 'ne')[0], 1.62)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds8, 'nw')[0], 1.89)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds8, 'ne')[0], 1.62)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds9, 'nw')[0], 1.89)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds9, 'ne')[0], 1.62)
        self.assertAlmostEqual(get_doors_area_with_direction(self.ds10, 'horizontal')[0], 1.755)
