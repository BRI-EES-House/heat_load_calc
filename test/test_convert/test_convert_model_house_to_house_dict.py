...
class ConvertModelHouseToHouseDict(unittest.TestCase):
    ...
    def test_earthfloor_perimeters(self):
        ...
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps1, NextSpace.OUTDOOR), 2)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps1, NextSpace.OPEN_UNDERFLOOR), 1)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps2, NextSpace.OUTDOOR), 2)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps2, NextSpace.OPEN_UNDERFLOOR), 1)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps3, NextSpace.OUTDOOR), 2)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps3, NextSpace.OPEN_UNDERFLOOR), 1)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps4, NextSpace.OUTDOOR), 4)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps6, NextSpace.OUTDOOR), 2)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps6, NextSpace.OPEN_UNDERFLOOR), 1)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps7, NextSpace.OUTDOOR), 2)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps7, NextSpace.OPEN_UNDERFLOOR), 1)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps8, NextSpace.OUTDOOR), 2)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps8, NextSpace.OPEN_UNDERFLOOR), 1)
        self.assertEqual(get_earthfloor_perimeters_next_space_number(self.eps9, NextSpace.OUTDOOR), 4)
