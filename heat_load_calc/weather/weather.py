...
def get_weather(region):
    ...
    dd['temperature [degree C]'] = theta_o_ns
    dd['absolute humidity [kg/kg(DA)]'] = x_o_ns
    ...
    dd.to_csv('weather.csv', encoding='utf-8')

    return theta_o_ns, i_dn_ns, i_sky_ns, r_n_ns, x_o_ns, h_sun_ns, a_sun_ns