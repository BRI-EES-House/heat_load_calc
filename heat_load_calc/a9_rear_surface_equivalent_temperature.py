...
def get_theta_o_sol_i_j_ns(boundary_type, is_sun_striked_outside, direction, spec,
        ...
        if is_sun_striked_outside:
            ...
            if boundary_type in [BoundaryType.ExternalGeneralPart, BoundaryType.ExternalOpaquePart]:
                ...
                return get_theta_o_sol_i_j_ns_with_solar(
                    a_s_i_j=spec.outside_solar_absorption,
                    eps_r_i_j=spec.outside_emissivity,
                    r_surf_o_i_j=spec.outside_heat_transfer_resistance,
