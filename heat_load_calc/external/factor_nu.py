...
class Direction(Enum):
    ...
    def get_nu(self, region: int, season: str) -> float:
        ...
        return {
            'heating': {
                Direction.TOP: {1: 1.000, 2: 1.000, 3: 1.000, 4: 1.000, 5: 1.000, 6: 1.000, 7: 1.000, 8: None},
                Direction.N: {1: 0.260, 2: 0.263, 3: 0.284, 4: 0.256, 5: 0.238, 6: 0.261, 7: 0.227, 8: None},
                Direction.NE: {1: 0.333, 2: 0.341, 3: 0.348, 4: 0.330, 5: 0.310, 6: 0.325, 7: 0.281, 8: None},
                Direction.E: {1: 0.564, 2: 0.554, 3: 0.540, 4: 0.531, 5: 0.568, 6: 0.579, 7: 0.543, 8: None},
                Direction.SE: {1: 0.823, 2: 0.766, 3: 0.751, 4: 0.724, 5: 0.846, 6: 0.833, 7: 0.843, 8: None},
                Direction.S: {1: 0.935, 2: 0.856, 3: 0.851, 4: 0.815, 5: 0.983, 6: 0.936, 7: 1.023, 8: None},
                Direction.SW: {1: 0.790, 2: 0.753, 3: 0.750, 4: 0.723, 5: 0.815, 6: 0.763, 7: 0.848, 8: None},
                Direction.W: {1: 0.535, 2: 0.544, 3: 0.542, 4: 0.527, 5: 0.538, 6: 0.523, 7: 0.548, 8: None},
                Direction.NW: {1: 0.325, 2: 0.341, 3: 0.351, 4: 0.326, 5: 0.297, 6: 0.317, 7: 0.284, 8: None},
                Direction.BOTTOM: {1: 0.000, 2: 0.000, 3: 0.000, 4: 0.000, 5: 0.000, 6: 0.000, 7: 0.000, 8: None},
            },
            'cooling': {
