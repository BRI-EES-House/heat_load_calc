...
from heat_load_calc.convert import a_01_01_general_part_u_value_directly
from heat_load_calc.convert import a_01_02_general_part_detail_method
...
def get_general_part_spec_hlc(gp_dict: Dict, gp: ees_house.GeneralPart) -> List[Tuple]:
    ...
    r_surf_i = gp.general_part_spec.r_srf_in
    r_surf_o = gp.general_part_spec.r_srf_ex
    ...
    if structure == 'wood':
        ...
        if method_wood == 'u_value_directly':
            ...
            return a_01_01_general_part_u_value_directly.get_wood_general_part_spec_hlc(
        ...
        # 2) 詳細入力法
            ...
            return a_01_02_general_part_detail_method.get_wood_general_part_spec_hlc(
    ...
    #      この場合、断熱材の厚さ（熱抵抗）を調整して負荷計算用の層構成を作成する。
        ...
        # 2) 詳細入力法（ただし、詳細に入力した場合に鉄骨ブレース等の熱橋の影響を補正するために、U値補正が入る。）
            ...
            return a_01_02_general_part_detail_method.get_steel_general_part_spec_hlc(
    ...
    #   2) 詳細入力法
        ...
        # 2) 詳細入力法
            ...
            return a_01_02_general_part_detail_method.get_rc_general_part_spec_hlc(
                parts=spec['parts'], r_surf_i=r_surf_i, r_surf_o=r_surf_o)
    ...
    #      あるいはそうみなされた計算方法が存在することが保証できないため設けない。
        ...
        # 1) 直接U値を指定する方法（特別な試験や型式等により取得したU値を活用することを想定）
        return a_01_01_general_part_u_value_directly.get_other_general_part_spec_hlc(
            general_part_type=gp_type, u_target=spec['u_value_other'], r_surf_i=r_surf_i, r_surf_o=r_surf_o, gp=gp)
