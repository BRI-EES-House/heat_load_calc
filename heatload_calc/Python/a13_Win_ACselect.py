...
# 当該時刻の窓開閉、空調発停を判定する
def get_theta_ot_target_i_n(
        is_radiative_heating, p_a_i_n, h_hum_i_n,
        theta_cl11_i_n, theta_cl03_i_n,
        operation_mode, clo_i_n
    ...
    return theta_ot_target


def get_clo_i_n(operation_mode):
    clo_i_n = {
...
def get_operation_mode_i_n(ac_demand_i_n, operation_mode_i_n_mns, pmv03_i_n, pmv07_i_n, pmv11_i_n):
