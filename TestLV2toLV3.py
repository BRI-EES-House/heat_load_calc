...
class TestLV2toLV3(unittest.TestCase):
    ...
    def test_make_parts(self):
        ...
        self.assertEqual('wood', ret[0]['Layers'][0]['name'])
        self.assertEqual(0.012, ret[0]['Layers'][0]['thick'])
        self.assertEqual(0.16, ret[0]['Layers'][0]['cond'])
        self.assertEqual(720, ret[0]['Layers'][0]['specH'])
    ...
    def test_make_wall_steel_ur(self):
        ...
        self.assertEqual('InputUR', ret['InputMethod'])
        self.assertEqual(1, len(ret['Parts']))
        self.assertEqual(1.0, ret['Radding'])
    ...
    def test_convert_wall(self):
        d = {
            ...
            'Walls': [
                ...
                'IsInContactWithOutsideAir': True, 'area': 67.8, 'WallConstructionMethod': 'WallInsuladdBackvertical',
                ...
                'IsInContactWithOutsideAir': True, 'area': 67.8, 'RoofConstructionMethod': 'Insulrafter', 
                ...
                'direction': 'top', 'IsInContactWithOutsideAir': True, 'area': 67.8, 'CeilingConstructionMethod': 'Insulbeam', 
                ...
                'direction': 'top', 'IsInContactWithOutsideAir': True, 'area': 67.8,
                'Parts': [{'Layers': [{'name': 'wood','thick': 0.012, 'cond': 0.16, 'specH': 720 },
                                      {'name': 'wood','thick': 0.012, 'cond': 0.16, 'specH': 720 }]}],
                'IsSunshadeInput': False },
                ...
                'direction': 'top','IsInContactWithOutsideAir': True, 'area': 67.8, 'Radding': 0.10, 
                'Parts': [{'Layers': [{'name': 'wood','thick': 0.012, 'cond': 0.16, 'specH': 720 },
                                      {'name': 'wood','thick': 0.012, 'cond': 0.16, 'specH': 720 }]}],         
                'IsSunshadeInput': False },
    ...
    def test_convert(self):
        ...
        d = {
            ...
            'Walls': [
                ...
                'IsSunshadeInput': False },
                { 'name': 'Floor', 'type': 'Floor', 'structure': 'wood', 'InputMethod' :'InputAllLayers', 'direction': 'bottom',
                'IsInContactWithOutsideAir': True, 'area': 67.8, 'FloorConstructionMethod' :'FrameInsulcolumn',
                'Parts': [{'TypeFloor': 'Insulation', 'Layers': [{'name': 'wood','thick': 0.012, 'cond': 0.16, 'specH': 720 },
                                                                 {'name': 'wood','thick': 0.012, 'cond': 0.16, 'specH': 720 }]},
                          {'TypeFloor': 'Heatbridge', 'Layers': [{'name': 'wood','thick': 0.012, 'cond': 0.16, 'specH': 720 },
                                                                 {'name': 'wood','thick': 0.012, 'cond': 0.16, 'specH': 720 }]}],
