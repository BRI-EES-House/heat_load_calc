...
def run_tick(pp: PreCalcParameters, gc_n: GroundConditions, ss: PreCalcParametersGround, n: int):
    ...
    #theta_dsh_srf_t_js_ms_npls = pp.bs.phi_t1_js_ms[is_ground, :] * pp.bs.k_eo_js[is_ground, :] * ss.theta_o_eqv_js_ns[:, [n]] + ss.r_js_ms * gc_n.theta_dsh_srf_t_js_ms_n
    theta_dsh_srf_t_js_ms_npls = pp.bs.phi_t1_js_ms[is_ground, :] * pp.bs.k_eo_js[is_ground, :] * ss.theta_o_eqv_js_ns[:, [n]] + pp.bs.r_js_ms[is_ground, :] * gc_n.theta_dsh_srf_t_js_ms_n
