...
class TestWindow(unittest.TestCase):
    ...
    def test_u_w_f(self):
        ...
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE).u_w_f_j, 4.7)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.RESIN).u_w_f_j, 2.2)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.WOOD).u_w_f_j, 2.2)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.MIXED_WOOD).u_w_f_j, 4.7)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.MIXED_RESIN).u_w_f_j, 4.7)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.ALUMINUM).u_w_f_j, 6.6)

    def test_r_a_w_g_j(self):

        # r_a_w_g_j と flame_type どちらも指定しない場合
        self.assertEqual(Window(u_w_j=0.1, eta_w_j=0.5, glass_type=GlassType.MULTIPLE).r_a_w_g_j, 0.8)
        # flame_type のみ指定しない場合
        self.assertEqual(Window(u_w_j=0.1, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.55).r_a_w_g_j, 0.55)
        # r_a_w_g_j のみ指定しない場合
        self.assertEqual(Window(u_w_j=0.1, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.RESIN).r_a_w_g_j, 0.72)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.WOOD).r_a_w_g_j, 0.72)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.MIXED_WOOD).r_a_w_g_j, 0.8)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.MIXED_RESIN).r_a_w_g_j, 0.8)
        self.assertEqual(Window(u_w_j=0.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, flame_type=FlameType.ALUMINUM).r_a_w_g_j, 0.8)
        # どちらも指定する場合
        self.assertEqual(Window(u_w_j=0.1, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.55, flame_type=FlameType.RESIN).r_a_w_g_j, 0.55)

    def test_u_w_g_j(self):

        # (3.0 - 2.2 * 0.28) / 0.72
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN).u_w_g_j, 3.3111111)

    def test_eta_w_g_j(self):
        
        # 0.5 / 0.72
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN).eta_w_g_j, 0.6944444)

    def test_u_w_g_s_j(self):
        # 1 / (1 / 3.3111111 - 0.0415 - 0.1228 + 0.0756 + 0.1317)
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._u_w_g_s_j, 2.89843795)

    def test_r_r_w_g_j(self):
        # ((1 / 2) * (1 / 3.3111111 - 0.0415 - 0.1228) + 0.0756) * 2.89843795
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._r_r_w_g_j, 0.4186988)
        # ((1 / 4) * (1 / 3.3111111 - 0.0415 - 0.1228 - 0.003) + 0.0756) * 2.89843795
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._r_r_w_g_j, 0.3167365)
    ...
    def test_rho_w_g_s1f_j(self):
        ...
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._rho_w_g_s1f_j, 0.1402048)

        # t_j = (-1.846 * 0.3167365 + ((1.846 * 0.3167365)**2 + 4 * (1 - 1.846 * 0.3167365) * 0.6944444)**0.5) / (2 * (1 - 1.846 * 0.3167365))
        # 0.923 * (t_j ** 2) - 1.846 * t_j + 1
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._rho_w_g_s1f_j, 0.12652496)

    def test_rho_w_g_s2f_j(self):
        self.assertEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._rho_w_g_s2f_j, None)
        self.assertEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._rho_w_g_s2f_j, 0.077)

    def test_tau_w_g_j(self):
        # (0.6944444 - (1 - 0.1402048) * 0.4186988) / (1 - 0.4186988)
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN).tau_w_g_j, 0.57534585)
        # (0.6944444 - (1 - 0.12652496) * 0.3167365) / ((1 - 0.3167365) - 0.077 * 0.3167365)
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN).tau_w_g_j, 0.63408559)

    def test_tau_w_g_s1_j(self):
        # 0.57534585
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._tau_w_g_s1_j, 0.57534585)
        # (0.379 * 0.077 * 0.63408559 + ((0.379 * 0.077 * 0.63408559)**2 - 4 * (0.379 * 0.077 - 1) * 0.63408559)**0.5) / 2
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._tau_w_g_s1_j, 0.79389655)

    def test_tau_w_g_s2_j(self):
        # 定義なし
        self.assertEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._tau_w_g_s2_j, None)
        # 0.79389655
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._tau_w_g_s2_j, 0.79389655)

    def test_rho_w_g_s1b_j(self):
        # 定義なし
        self.assertEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._rho_w_g_s1b_j, None)
        # 0.379 * (1 - 0.79389655)
        self.assertAlmostEqual(Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)._rho_w_g_s1b_j, 0.07811320)
    ...
    def test_get_rho_w_g_s2f_j_phi_function(self):
        w_m = Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)
        # 0.077 + (1.0 - 0.077) * 0.0
    ...
    def test_get_rho_w_g_s1f_j_phi_function(self):
        ...
        w_s = Window(u_w_j=3.0, eta_w_j=0.5, glass_type=GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=FlameType.RESIN)
