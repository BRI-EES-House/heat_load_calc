...
class TestWindow(unittest.TestCase):
    ...
    def test_get_rho_w_g_s2f_j_phi_function(self):
        ...
        # 0.077 + (1.0 - 0.077) * 0.0
        self.assertAlmostEqual(w_m._get_rho_w_g_s2f_j_phis(phi_ns=radians(0.0)), 0.077)
        # 0.077 + (1.0 - 0.077) * 0.00292295
        self.assertAlmostEqual(w_m._get_rho_w_g_s2f_j_phis(phi_ns=radians(30.0)), 0.07969788)
        # 0.077 + (1.0 - 0.077) * 0.06190624
        self.assertAlmostEqual(w_m._get_rho_w_g_s2f_j_phis(phi_ns=radians(60.0)), 0.13413946)
        # 0.077 + (1.0 - 0.077) * 1.0
        self.assertAlmostEqual(w_m._get_rho_w_g_s2f_j_phis(phi_ns=radians(90.0)), 1.0)

    def test_get_rho_w_g_s1b_j_phi_function(self):
        w_m = Window(u_w_j=3.0, eta_w_j=0.5, glass_type=Window.GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=Window.FlameType.RESIN)
        # 0.07811320 + (1.0 - 0.07811320) * 0.0
        self.assertAlmostEqual(w_m._get_rho_w_g_s1b_j_phis(phi_ns=radians(0.0)), 0.0781132)
        # 0.07811320 + (1.0 - 0.07811320) * 0.00292295
        self.assertAlmostEqual(w_m._get_rho_w_g_s1b_j_phis(phi_ns=radians(30.0)), 0.08080783)
        # 0.07811320 + (1.0 - 0.07811320) * 0.06190624
        self.assertAlmostEqual(w_m._get_rho_w_g_s1b_j_phis(phi_ns=radians(60.0)), 0.13518375)
        # 0.07811320 + (1.0 - 0.07811320) * 1.0
        self.assertAlmostEqual(w_m._get_rho_w_g_s1b_j_phis(phi_ns=radians(90.0)), 1.0)
    ...
    def test_get_tau_w_g_s2_j_phi_function(self):
        w_m = Window(u_w_j=3.0, eta_w_j=0.5, glass_type=Window.GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=Window.FlameType.RESIN)
        # 0.79389655 * 0.999
        self.assertAlmostEqual(w_m._get_tau_w_g_s2_j_phis(phi_ns=radians(0.0)), 0.79310266)
        # 0.79389655 * 0.98911757
        self.assertAlmostEqual(w_m._get_tau_w_g_s2_j_phis(phi_ns=radians(30.0)), 0.78525703)
        # 0.79389655 * 0.88375
        self.assertAlmostEqual(w_m._get_tau_w_g_s2_j_phis(phi_ns=radians(60.0)), 0.70160608)
        # 0.79389655 * 0.0
        self.assertAlmostEqual(w_m._get_tau_w_g_s2_j_phis(phi_ns=radians(90.0)), 0.0)

    def test_get_tau_w_g_s1_j_phi_function(self):

        w_s = Window(u_w_j=3.0, eta_w_j=0.5, glass_type=Window.GlassType.SINGLE, r_a_w_g_j=0.72, flame_type=Window.FlameType.RESIN)
        # 0.57534585 * 0.999
        self.assertAlmostEqual(w_s._get_tau_w_g_s1_j_phis(phi_ns=radians(0.0)), 0.57477050)
        # 0.57534585 * 0.98911757
        self.assertAlmostEqual(w_s._get_tau_w_g_s1_j_phis(phi_ns=radians(30.0)), 0.56908469)
        # 0.57534585 * 0.88375
        self.assertAlmostEqual(w_s._get_tau_w_g_s1_j_phis(phi_ns=radians(60.0)), 0.50846189)
        # 0.57534585 * 0.0
        self.assertAlmostEqual(w_s._get_tau_w_g_s1_j_phis(phi_ns=radians(90.0)), 0.0)

        w_m = Window(u_w_j=3.0, eta_w_j=0.5, glass_type=Window.GlassType.MULTIPLE, r_a_w_g_j=0.72, flame_type=Window.FlameType.RESIN)
        # 0.79389655 * 0.999
        self.assertAlmostEqual(w_m._get_tau_w_g_s1_j_phis(phi_ns=radians(0.0)), 0.79310266)
        # 0.79389655 * 0.98911757
        self.assertAlmostEqual(w_m._get_tau_w_g_s1_j_phis(phi_ns=radians(30.0)), 0.78525703)
        # 0.79389655 * 0.88375
        self.assertAlmostEqual(w_m._get_tau_w_g_s1_j_phis(phi_ns=radians(60.0)), 0.70160608)
        # 0.79389655 * 0.0
        self.assertAlmostEqual(w_m._get_tau_w_g_s1_j_phis(phi_ns=radians(90.0)), 0.0)
