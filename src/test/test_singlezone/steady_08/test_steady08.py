...
class TestSteadyState(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        c_n = conditions.Conditions(
            ...
            theta_dsh_s_t_js_ms_n=(np.dot(ss.bs.k_ei_js_js, theta_ei_js_n) + ss.k_eo_js * ss.theta_o_eqv_js_ns[:, 1].reshape(-1, 1) + np.dot(ss.bs.k_s_r_js_is, theta_r_is_n)) * ss.phi_t1_js_ms / (1.0 - ss.r_js_ms),
            q_s_js_n=q_srf_js_n,
